...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"editTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editTour = exports.deleteTour = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var editTour = exports.editTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, tourData) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          stripe = Stripe(session.data.stripePublicKey); // Assuming you're sending the public key from the server
        ...
        case 14:
          ...
          (0, _alerts.showAlert)('error', _context.t0.message || 'An error occurred during checkout. Please try again.');
        case 18:
        case "end":
          return _context.stop();
      }
...
var _editTour = require("./editTour");
...
var tourForm = document.querySelector('.form-tour-data');
...
if (tourForm) tourForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var tourId = document.getElementById('tour-id').value;
  var name = document.getElementById('name').value;
  var price = document.getElementById('price').value;
  var duration = document.getElementById('duration').value;
  // Add other fields as necessary

  (0, _editTour.editTour)(tourId, {
    name: name,
    price: price,
    duration: duration
  });
...
document.addEventListener('DOMContentLoaded', function () {
  var deleteButtons = document.querySelectorAll('.btn-delete-tour');
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return (0, _editTour.deleteTour)(tourId);
            case 5:
            case "end":
              return _context2.stop();
          }
